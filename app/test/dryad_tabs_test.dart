...
import 'package:dryad/features/dryad/models/dryad_models.dart';
import 'package:dryad/features/dryad/dryad_providers.dart';
...
void main() {
  ...
  final ownedTree = DryadTree(
    id: 'tree-001',
    name: 'Dryad Tree 1001',
  ...
  testWidgets('bottom nav is tree-centric and renders map/tend/market/my trees/creator', (tester) async {
    ...
    expect(find.text('Dryad Tree 1001'), findsOneWidget);

    await tester.tap(find.text('My Trees').last);
    await tester.pumpAndSettle();
    expect(find.textContaining('Dryad Tree 1001'), findsOneWidget);
