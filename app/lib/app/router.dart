...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: AppRoutes.collection, name: 'collection', builder: (context, state) => const HomePage(initialTab: HomeTab.inventory)),
      GoRoute(path: AppRoutes.profile, name: 'profile', builder: (context, state) => const HomePage(initialTab: HomeTab.profile)),
      GoRoute(path: AppRoutes.squad, name: 'squad', builder: (context, state) => const HomePage(initialTab: HomeTab.squad)),
      GoRoute(path: AppRoutes.inventory, name: 'inventory', builder: (context, state) => const HomePage(initialTab: HomeTab.inventory)),
      ...
      GoRoute(path: AppRoutes.progression, name: 'progression', builder: (context, state) => const HomePage(initialTab: HomeTab.progression)),
      ...
      GoRoute(path: AppRoutes.debugMap, name: 'debug-map', builder: (context, state) => const PerbugMapDebugPage()),
