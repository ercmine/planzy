...
import '../data/perbug_seed_data.dart';

class PerbugMapClaimPage extends StatelessWidget {
  const PerbugMapClaimPage({super.key, required this.onOpenTree});
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        ...PerbugSeedData.unclaimedSpots.map(
          (spot) => Padding(
