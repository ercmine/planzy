...
class DryadCreatorPage extends ConsumerStatefulWidget {
  const DryadCreatorPage({super.key, required this.onOpenTree});

  final ValueChanged<String> onOpenTree;

  @override
  ConsumerState<DryadCreatorPage> createState() => _DryadCreatorPageState();
}

class _DryadCreatorPageState extends ConsumerState<DryadCreatorPage> {
  ...
  List<_CreatorSummary> _creatorSummary(List<DryadTree> trees) {
    final grouped = <String, List<DryadTree>>{};
