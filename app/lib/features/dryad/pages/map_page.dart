...
class DryadMapPage extends ConsumerStatefulWidget {
  const DryadMapPage({super.key, required this.onOpenTree});

  final ValueChanged<String> onOpenTree;

  @override
  ConsumerState<DryadMapPage> createState() => _DryadMapPageState();
}

class _DryadMapPageState extends ConsumerState<DryadMapPage> {
  DryadTree? _selectedTree;
  ...
  List<DryadTree> _localTrees(List<DryadTree> trees, double centerLat, double centerLng) {
    final sorted = [...trees]
      ..sort((a, b) {
