...
describe("accounts service", () => {
  ...
  it("enforces business context and member role rules", () => {
    ...
    expect(() =>
      service.inviteBusinessMember(managerActor, {
        businessProfileId: business.id,
        userId: "viewer",
    ...
    expect(() => service.resolveActingContext("outsider", { profileType: ProfileType.BUSINESS, profileId: business.id })).toThrow(
      "BUSINESS_CONTEXT_NOT_ALLOWED"
    );
  });
