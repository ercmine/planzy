...
function place(overrides: Partial<CanonicalPlace>): CanonicalPlace {
  return {
...
function source(overrides: Partial<PlaceSourceRecord> = {}): PlaceSourceRecord {
  return {
    sourceRecordId: "s1",
    provider: "foursquare",
    providerPlaceId: "p1",
