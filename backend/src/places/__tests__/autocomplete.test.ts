...
function buildPlace(input: Partial<CanonicalPlace> & { canonicalPlaceId: string; primaryDisplayName: string; locality?: string; region?: string; latitude: number; longitude: number }): CanonicalPlace {
