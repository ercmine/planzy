const CATEGORY_RULES: Array<{ pattern: RegExp; category: string; subcategory?: string; tags?: string[] }> = [
...
export function resolveCanonicalCategory(providerCategories: string[], placeName: string): CategoryResolution {
