...
describe("analytics foundation", () => {
  ...
  it("aggregates creator/business/admin summaries", async () => {
    ...
    await analytics.ingestBatch({ actorUserId: "u1", creatorId: "creator-1", actorProfileType: "creator", platform: "backend" } as never, [
    ...
    await analytics.ingestBatch({ actorUserId: "u2", businessId: "biz-1", actorProfileType: "business", platform: "backend" } as never, [
