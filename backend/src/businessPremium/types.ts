...
export type BusinessEntitlementKey =
  | "business.analytics.advanced"
  | "business.featuredPlacement.eligible"
  | "business.creatorCollab.enabled"
  | "business.locations.multiLocation"
  | "business.campaigns.enabled"
  | "business.profile.enhanced"
  | "business.reporting.export"
  | "business.insights.audienceBreakdown"
  | "business.insights.creatorImpact"
  | "business.insights.competitiveBenchmarksScaffold"
...
export interface BusinessUpgradeContext {
  ...
  locked: Array<{ feature: BusinessEntitlementKey; recommendedTier: Exclude<BusinessTier, "standard">; message: string }>;
}
