...
import type { PerbugTree, SpotRef, WalletAddress } from "../domain.js";
...
describe("PerbugMarketplaceService", () => {
  it("treats trees without an assigned place as dug up and replantable", () => {
    ...
    const unassignedTree: PerbugTree = {
    ...
    const service = new PerbugMarketplaceService([unassignedTree], [], [spot]);
  ...
  it("builds cohesive flywheel signals for tend, market, map, progression, and loop metrics", () => {
    ...
    const service = new PerbugMarketplaceService([treeA, treeB], [], [
  ...
  it("enforces 500m planting eligibility boundary", () => {
    ...
    const wallet = "0x7777777777777777777777777777777777777777" as WalletAddress;
