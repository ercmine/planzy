...
describe("creator monetization service", () => {
    ...
    it("blocks monetization until creator is verified and on monetization plan", async () => {
        ...
        subscriptions.ensureAccount(creator.id, "CREATOR");
    ...
    it("locks premium guides for viewers without entitlement", async () => {
        ...
        const guide = await creatorService.createGuide("u2", creator.id, { title: "Hidden", summary: "Secret", body: "full premium", status: "published", placeItems: [{ placeId: "x" }] });
