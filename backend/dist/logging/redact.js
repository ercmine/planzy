...
export function coarseGeo(lat, lng) {
    return { cell: geoCell(lat, lng, 3) };
}
export function hashString(input) {
    return createHash("sha256").update(input).digest("hex").slice(0, 12);
}
function looksSensitiveText(input) {
...
export function safeTextHint(input, maxLen = 40) {
...
function redactValue(value, depth, keyHint) {
    if (depth > MAX_DEPTH) {
        return "[TRUNCATED]";
    }
