...
export interface CreatorMilestoneDefinition {
    ...
    title: string;
    threshold: number;
    metric: "daily_streak" | "weekly_streak" | "quality_publishes" | "trusted_reviews" | "trusted_clean_days" | "city_distinct_places" | "city_neighborhoods" | "category_distinct_places" | "district_distinct_places";
    cityId?: string;
    categoryId?: string;
    districtId?: string;
...
export type PublishSuppressionReason = "moderation_blocked" | "suspicious_activity" | "quality_gate" | "daily_publish_cap" | "repeat_place_cap" | "repeat_place_cooldown" | "trust_gate";
