...
export class MemoryIdeasStore {
    ideasBySession = new Map();
    async addIdea(sessionId, input, meta) {
    ...
    async listIdeas(sessionId, opts) {
        const cleanSessionId = validateSessionId(sessionId);
    ...
    async deleteIdea(sessionId, ideaId, meta) {
        const cleanSessionId = validateSessionId(sessionId);
