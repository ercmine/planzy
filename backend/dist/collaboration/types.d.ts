...
export interface CreatorBusinessInvite {
    id: string;
    ...
    expiresAt?: string;
    status: InviteStatus;
    disclosureExpectation: DisclosureLabel;
...
export interface CreatorBusinessCampaign {
    id: string;
    businessProfileId: string;
    title: string;
    description?: string;
...
export interface CampaignContentLink {
    id: string;
    campaignId: string;
    creatorProfileId: string;
...
export interface CollaborationAuditEvent {
    id: string;
    entityType: "invite" | "campaign" | "content_link" | "featured_content";
    entityId: string;
    action: string;
    actorUserId: string;
    businessProfileId?: string;
