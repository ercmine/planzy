import { ANALYTICS_EVENT_NAMES } from "./events.js";
...
function sanitizeMetadata(value) {
    ...
    for (const [k, v] of Object.entries(obj)) {
        if (BLOCKED_METADATA_KEYS.includes(k))
            continue;
        if (typeof v === "string") {
...
export function validateAnalyticsEventName(name) {
...
export function sanitizeAnalyticsContext(input) {
    return {
        ...input,
