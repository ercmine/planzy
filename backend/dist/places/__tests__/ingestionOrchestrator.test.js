...
import { MultiSourcePlaceIngestionService } from "../ingestion.js";
...
function providerWith(records, options) {
    return {
        metadata: {
            provider: "foursquare",
            costTier: "low",
...
describe("MultiSourcePlaceIngestionService", () => {
    it("uses primary provider without fallback when enough results", async () => {
        ...
        const context = { intent: "text_search", queryText: "coffee", resultLimit: 2 };
    ...
    it("falls back when primary provider underfills", async () => {
        ...
        const ingestion = new MultiSourcePlaceIngestionService(service, new Map([
            ["foursquare", fsq],
    ...
    it("uses cache to avoid duplicate provider calls", async () => {
        ...
        const context = { intent: "text_search", queryText: "coffee", resultLimit: 1 };
