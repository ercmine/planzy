...
function makePlace(id, name, lat, lng) {
    return {
        canonicalPlaceId: id,
        slug: id,
        status: "active",
...
function makeSource(sourceRecordId, canonicalPlaceId, provider = "osm") {
    return {
        sourceRecordId,
        provider,
...
describe("place maintenance", () => {
    ...
    it("reassigns place attachments safely", () => {
        ...
        const link = { id: "rev-1", placeId: "a", attachmentType: "review", attachmentId: "r-1", metadata: {} };
