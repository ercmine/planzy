function isWithinBounds(place, bounds) {
    if (place.latitude > bounds.north || place.latitude < bounds.south)
        return false;
...
function buildGridKey(place, bounds, buckets) {
...
export function searchCanonicalPlacesInBounds(places, query) {
