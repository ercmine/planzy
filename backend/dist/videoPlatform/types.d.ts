export type VideoLifecycleStatus = "draft" | "awaiting_upload" | "uploading" | "upload_received" | "processing_queued" | "processing" | "processed" | "publish_pending" | "published" | "failed_upload" | "failed_processing" | "moderation_pending" | "hidden" | "rejected" | "archived";
export type ModerationStatus = "pending" | "approved" | "review" | "flagged" | "rejected";
export interface VideoModerationFrameEvidence {
    timestampMs: number;
    thumbnailUrl?: string;
    labels: string[];
    score: number;
}
export interface VideoModerationSummary {
    nudityScore: number;
