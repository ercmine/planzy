...
export declare class MemoryCreatorStore implements CreatorStore {
    private readonly profilesById;
    private readonly profileSlugToId;
    private readonly profileHandleToId;
    private readonly follows;
    private readonly guides;
    private readonly analytics;
    private readonly guideViews;
