...
export declare class MemoryCompetitionStore implements CompetitionStore {
    private readonly seasons;
    private readonly missions;
    private readonly progress;
    private readonly leaderboards;
    private readonly leaderboardEntries;
    private readonly qualitySnapshots;
    private readonly likeEvents;
    private readonly tipEvents;
    private readonly reviewEvents;
