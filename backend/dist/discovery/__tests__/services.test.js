...
import { CategoryBrowseService, CityPageService, DiscoveryFeedService, AdInsertionService, NearbyDiscoveryService, PlaceSearchService, RecommendationService, TrendingService } from "../services.js";
...
describe("discovery services", () => {
    ...
    it("balances diversity and avoids creator spam", async () => {
        ...
        const creatorCounts = rec.items.reduce((acc, item) => {
