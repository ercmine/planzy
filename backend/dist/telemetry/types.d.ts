export type TelemetryEventName = "deck_loaded" | "card_viewed" | "card_opened" | "swipe" | "outbound_link_clicked";
...
export type TelemetryEventInput = DeckLoadedEvent | CardViewedEvent | CardOpenedEvent | SwipeEvent | OutboundLinkClickedEvent;
