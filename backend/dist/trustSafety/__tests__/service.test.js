...
describe("TrustSafetyService", () => {
    it("applies moderation penalties to content trust", async () => {
        ...
        const target = { targetType: "place_review_video", targetId: "vid-1", placeId: "place-1", subjectUserId: "creator-1" };
    ...
    it("aggregates creator and place trust", async () => {
        const moderation = new ModerationService();
        const service = new TrustSafetyService(moderation);
        const clean = { targetType: "place_review_video", targetId: "vid-clean", placeId: "p1", subjectUserId: "creator-1" };
        const removed = { targetType: "place_review_video", targetId: "vid-removed", placeId: "p1", subjectUserId: "creator-1" };
