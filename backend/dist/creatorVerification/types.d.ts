...
export interface CreatorVerificationEligibilityCheck {
    code: CreatorVerificationEligibilityCode;
    passed: boolean;
    severity: CreatorVerificationEligibilitySeverity;
    message: string;
}
export interface CreatorVerificationEligibilityResult {
    eligible: boolean;
    checks: CreatorVerificationEligibilityCheck[];
    failedChecks: CreatorVerificationEligibilityCheck[];
    warnings: CreatorVerificationEligibilityCheck[];
    summary: string;
    evaluatedAt: string;
}
export interface CreatorVerificationApplicationDraft {
    reason: string;
    niche?: string;
    cityRegion?: string;
...
export interface CreatorVerificationApplication {
    ...
    draft: CreatorVerificationApplicationDraft;
    ...
    rejectedAt?: string;
    revokedAt?: string;
    rejectionReasonCode?: CreatorVerificationRejectionReasonCode;
    revocationReasonCode?: CreatorVerificationRevocationReasonCode;
    internalNotes?: string;
    publicMessage?: string;
    reapplyEligibleAt?: string;
    createdAt: string;
    updatedAt: string;
}
export interface CreatorVerificationAuditEvent {
    id: string;
    applicationId: string;
    creatorProfileId: string;
    actorUserId: string;
    eventType: CreatorVerificationAuditEventType;
    details?: Record<string, unknown>;
    createdAt: string;
}
export interface CreatorVerificationAdminListFilter {
    status?: CreatorVerificationStatus;
    creatorProfileId?: string;
    userId?: string;
}
export interface CreatorVerificationPublicBadge {
    isVerified: boolean;
    label?: string;
    badgeType?: "verified_creator";
    approvedAt?: string;
}
export interface CreatorVerificationConfig {
    minAccountAgeDays: number;
    minPublicContentCount: number;
    rejectionCooldownDays: number;
    blockOnModerationFlags: string[];
}
export declare const DEFAULT_CREATOR_VERIFICATION_CONFIG: CreatorVerificationConfig;
