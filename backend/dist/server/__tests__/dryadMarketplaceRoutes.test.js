...
describe("dryad marketplace routes", () => {
    it("supports listing browse, claim+plant, and buy from anywhere", async () => {
        ...
        const initial = await market.json();
    ...
    it("enforces dig-up payment and allows replanting on an unclaimed spot", async () => {
        ...
        const eligibilityJson = await eligibility.json();
        ...
        const treeAfterDigUpJson = await treeAfterDigUp.json();
        ...
        const spotsJson = await spots.json();
        ...
        const replantIntent = await createReplantIntent.json();
        ...
        const replantableJson = await replantable.json();
    ...
    it("supports owned trees query and remote watering cooldown", async () => {
        ...
        const ownedJson = await owned.json();
        ...
        const waterEligibilityJson = await waterEligibility.json();
        ...
        const wateredTree = await water.json();
        ...
        const cooldownEligibilityJson = await cooldownEligibility.json();
