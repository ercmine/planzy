export type ModerationTargetType = "review" | "review_media" | "place_review_video" | "guide" | "creator_profile" | "place_media" | "business_reply" | "business_review_response" | "review_caption" | "review_title" | "media_caption" | "media_title" | "media_thumbnail";
export type ModerationState = "active" | "pending_review" | "auto_limited" | "hidden" | "removed" | "rejected" | "restored" | "escalated";
export type ModerationSource = "user_report" | "automated_rule" | "admin_manual";
export type ModerationSeverity = "low" | "medium" | "high" | "critical";
export type ReportReasonCode = "spam" | "harassment_bullying" | "hate_abusive_language" | "sexual_explicit" | "graphic_violent" | "dangerous_illegal" | "misleading_fake_review" | "off_topic_irrelevant" | "impersonation_stolen_content" | "privacy_violation" | "self_harm_concern" | "scam_fraud" | "other";
...
export interface ModerationSignal {
    ...
    category: "spam" | "toxicity" | "abuse" | "duplicate" | "suspicious_activity" | "scam_fraud" | "low_quality" | "unsafe_media" | "policy_keyword";
    ruleId: string;
...
export type ModerationDecisionType = "keep" | "warn" | "limit_visibility" | "hide" | "remove" | "reject" | "restore" | "escalate_user_review" | "lock_edits";
...
export interface ModerationAuditEvent {
    id: string;
    target: ModerationTargetRef;
    eventType: "report_created" | "signal_generated" | "state_transition" | "decision_recorded" | "report_resolved" | "content_restored";
    actorUserId?: string;
    source: ModerationSource;
