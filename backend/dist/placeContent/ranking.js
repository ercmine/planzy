...
export const DEFAULT_FIRST_PARTY_RANKING_CONFIG = {
...
export function computeFirstPartyRankingSignals(metrics, config = DEFAULT_FIRST_PARTY_RANKING_CONFIG) {
    ...
    const cappedTotalBoost = Math.min(config.maxTotalBoost, hasReviewsBoost
        + reviewCountBoost
        + creatorVideoBoost
        + saveCountBoost
        + guideInclusionBoost
